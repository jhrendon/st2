...
class OrquestaNotifyTest(st2tests.DbTestCase):
    ...
    def test_notify_task_list_item_value(self):
        ...
        for notify_tasks in expected_failure_test_cases:
        ...
        expected_success_test_cases = [
            ['init_task']       # String value with underscore is OK.
        ]

        for notify_tasks in expected_success_test_cases:
            lv_ac_db.parameters = {'notify': notify_tasks}
